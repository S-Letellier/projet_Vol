...
class CRUDAvion
{
    ...
    {
        $bdd = new BDD();
        $req = $bdd->getBdd()->prepare('INSERT INTO avion (nom,capacite,fournisseur)VALUES (:nom,:capacite,:fournisseur)');
        $req->execute(array(
            'nom' => $this->nom,
    ...
    public function setUpdate(){
        $bdd = new BDD();
        $req = $bdd->getBdd()->prepare('Update avion set nom = :nom,capacite = :capacite,fournisseur = :fournisseur where id= :id');
        $req->execute(array(
